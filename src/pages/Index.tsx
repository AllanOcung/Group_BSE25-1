...
const Index = () => {
  ...
  const featuredProjects = [
    ...
    },
    {
      ...
      description: "Smart task management app powered by AI for automated categorization and priority suggestions. Built with Next.js and OpenAI API.",
  ...
  const recentPosts = [
    {
      ...
      excerpt: "Learn the latest patterns and practices for building maintainable React applications that can scale with your team and user base.",
    ...
    },
    {
      ...
      excerpt: "Explore the emerging trends in web development, from AI integration to new frameworks and tools that are shaping the industry.",
        ...
        <section className="py-20">
          <div className="container">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                We're passionate about creating innovative solutions across different domains
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Full-stack web applications using modern technologies and best practices
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Beautiful and intuitive designs that prioritize user experience and accessibility
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Read our latest blog posts about development, design, and industry trends
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-hero">
          <div className="container text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Connect with like-minded creators, showcase your work, and collaborate on exciting projects
            </p>
