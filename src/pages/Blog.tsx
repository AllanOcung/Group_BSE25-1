  ...
  const blogPosts = [
    {
      ...
      excerpt: "Learn the latest patterns and practices for building maintainable React applications that can scale with your team and user base. We'll cover component architecture, state management, and performance optimization.",
    ...
    },
    {
      ...
      excerpt: "Explore the emerging trends in web development, from AI integration to new frameworks and tools that are shaping the industry. Discover what's coming next in the world of frontend development.",
      coverImage: "https://images.unsplash.com/photo-1517077304055-6e89abbf09b0?w=400&h=250&fit=crop",
      author: "David Kim",
    ...
    },
    {
      ...
      excerpt: "Discover how to integrate machine learning capabilities into mobile applications. We'll cover TensorFlow Lite, Core ML, and practical implementation strategies for common ML use cases.",
    ...
    },
    {
      ...
      excerpt: "Learn how to create and maintain design systems that ensure consistency across your products. We'll explore tools, processes, and best practices for scalable design.",
    ...
    },
    {
      ...
      excerpt: "Implement DevOps practices without enterprise complexity. Learn about CI/CD, infrastructure as code, and monitoring strategies that work for small development teams.",
    ...
    },
    {
      ...
      excerpt: "Master the principles of good API design. From RESTful conventions to GraphQL schemas, learn how to create APIs that developers love to use.",
      coverImage: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=400&h=250&fit=crop",
      author: "Jordan Martinez",
      authorAvatar: "https://images.unsplash.com/photo-1519345182560-3f2917c472ef?w=40&h=40&fit=crop&crop=face",
              ...
              <div className="lg:col-span-3">
                <div className="mb-8">
                  ...
                  <p className="text-muted-foreground">
                    Stay up to date with the latest trends and best practices in tech.
                  </p>
                </div>
