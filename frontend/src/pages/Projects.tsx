...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Comprehensive design system built with React and Storybook, featuring reusable components and design tokens for consistent UIs.",
    ...
    },
    {
      ...
      description: "Analytics dashboard for social media management with real-time data visualization, scheduling tools, and performance metrics.",
    ...
    },
    {
      ...
      description: "Comprehensive fitness tracking mobile app with workout planning, progress monitoring, and social features for motivation.",
      image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=300&fit=crop",
      techStack: ["Flutter", "Firebase", "Google Fit API"],
      githubUrl: "#",
      liveUrl: "#",
      author: "Lisa Park",
      authorAvatar: "https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?w=40&h=40&fit=crop&crop=face"
    }
  ];
